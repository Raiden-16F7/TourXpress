		...
		<SafeAreaView className="flex-1 relative">
			...
			<View className="px-6 mt-8 space-y-6">
				...
				<Text style={{ textAlign: "justify" }}>
					Welcome to TourXpress - Get ready to embark on a seamless and
					immersive travel experience, where every destination is just a tap
					away. Let's turn your travel dreams into reality!"
				</Text>
			</View>
			...
			<Animatable.View
				...
				className=" items-end my-12 mr-8">
				<FAB
					mode="elevated"
					className="bg-[#6df0da]"
					size="medium"
